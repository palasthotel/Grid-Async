import {Backend, Component, Events, GridAsyncSocket} from "Grid";

export const buildLockingComponent = (backend: Backend, events: Events): Component => {
    ...
    return {
        ...
        onDisconnect(socket) {
            if(socket.hasLock){
                let hit: GridAsyncSocket|null = null;
